	...
	var Mask = (function () {
	  ...
	  _createClass(Mask, [{
	    ...
	    value: function fadeIn() {
	      ...
	      var tl = new TimelineMax({
	        onComplete: (function () {
	          ...
	          _this.webgl.fadeInComp();
	        }).bind(this)
	      });

	      tl.fromTo(this.uniforms.uProgress, 4, { value: 0 }, { value: 1 }, 0).to(this.uniforms.uBgProgress, 2, { value: 1, ease: Power4.easeOut }, 0);
	    }
	  }, {
	    key: "fadeOut",
	    value: function fadeOut() {
	      ...
	      tl.add("start", 3.5).fromTo(this.uniforms.uProgress, 4, { value: 0 }, { value: 1 }, "start").fromTo(this.uniforms.uBgProgress, 1, { value: 1 }, { value: 0, delay: 0.4, ease: Power4.easeIn }, "start");
	    }
	  }, {
	    key: "render",
...
/***/ (function(module, exports) {
	...
	var Audio = (function () {
	  ...
	  _createClass(Audio, [{
	    ...
	    key: "setAudio",
	    value: function setAudio(startTime, isResume) {
	    ...
	    key: "connectNode",
	    value: function connectNode(buffer, startTime) {
	      this.source = this.audioContext.createBufferSource();
	    ...
	    key: "detectFadeout",
	    value: function detectFadeout() {
	      var beat = this.beatCount[0] - 4;
